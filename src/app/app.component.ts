...
export class AppComponent {
    ...
    public worksList = [
	{className : 'ackye', text : 'Angular 14. DevExtreme. Работа на проекте РОССЕТИ и РЖД РФ. Система управления и учета электроэнергии, точки учета. Автоматизация и опрос счетчиков электроэнергии, оплата, личный кабинет. Динамические графики нагрузки / потребления (ChartJs)', header : 'Проект ИСУ «КУБ»', img : '/assets/imgs/ackye/kub.png', bgcolor : '#fffdf3', href : 'https://dev-amr1:5550', git: ''},
	{className : 't1-consulting', text : 'Angular 14. Работа на проекте T1- CRM, компании Т1 Консалтинг. Система управления и взаимодействия с клиентами. Разработка и сопровождение нескольких модулей в CRM системе, согласно технической документации: (Задачи, Вложения, Мероприятия, Отчеты). Последний реализован практически полностью', header : 'Проект T1-CRM компании Т1 Консалтинг', img : '/assets/imgs/t1-crm/Image 1.png', bgcolor : '#fffdf3', href : 'assets/imgs/t1-crm/repots.mp4', git : 'https://t1crm-demo.t1-consulting.ru/'},
	...
	{className : 'ros-alcohol', text : 'Проект личного кабинета руководителя Росалкогольрегулирования. Внутренний проект. Очень интересный проект динамического отображения данных производства, продажи, акцизов и пр.. в сфере алкогольной продукциию. Небольшое видео - гид по проекту, основанный на тестовых данных можно посмотреть, кликнув на текст заголовка.', img : 'assets/imgs/rosalcohol/rosalcohol.png', bgcolor : '#fffdf3', href : 'assets/imgs/rosalcohol/11-03-2021.mp4', git : '#'},
