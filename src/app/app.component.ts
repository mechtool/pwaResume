...
export class AppComponent {
    ...
    public worksList = [
	{className : 'ackye', text : 'Angular 14. Работа на проекте РОССЕТИ и РЖД РФ. Система управления и учета электроэнергии, точки учета. Автоматизация и опрос счетчиков электроэнергии, оплата, личный кабинет.', header : 'Проект ИСУ «КУБ»', img : '/assets/imgs/ackye/kub.png', bgcolor : '#fffdf3', href : 'https://dev-amr1:5550', git: ''},
