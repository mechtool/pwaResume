...
export class AppComponent {
    ...
    public worksList = [
	{className : 'ackye', text : 'Angular 14. Работа на проекте РОССЕТИ и РЖД РФ. Система управления и учета электроэнергии', header : 'Проект ИСУ «КУБ»', img : '/assets/imgs/ackye/kub.png', bgcolor : '#fffdf3', href : 'assets/imgs/t1-crm/repots.mp4', git : 'https://t1crm-demo.t1-consulting.ru/'},
