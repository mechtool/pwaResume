...
export class AppComponent {
    ...
    public worksList = [
	{className : 'call-all', text : 'Текущая работа. Два месяца пишу PWA приложение (с установкой на экран устройства) для обмена сообщениями на интерфейсе WebRtc. Сервер - ServerLess хост на Firebase без облачных функций, база данных на Firebase Database. Пишу на css-flex, для много-пользовательского общения (текст, видео , аудио) в виде прямой конференции, но будет в демо для пары пиров. Push-Notification для сигнализации на мобильных устройствах, остальная сторона сигнализации через механизмы событий базы Database.', header : 'Приложение для обмена сообщениями.', img : 'assets/imgs/worksList/call-all.jpg', bgcolor : '#fffdf3', href : 'https://web-rtc-firebase-bd8fe.firebaseapp.com/', git : 'https://github.com/mechtool/web-rtc-firebase'},
