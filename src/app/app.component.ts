...
export class AppComponent {
    ...
    public worksList = [
	{className : 'call-all', text : 'Текущая работа. Два месяца пишу на Angular PWA приложение (с установкой на экран устройства) для обмена сообщениями на интерфейсе WebRtc. Явно реализую обмен видеопотоками, а медиаданные передаються через организацию канала передачи данных не явно. Сервер - Node.js - Express хост на Heroku, с реализацией Angular-Universal, настройки кэширования через ServiceWorker для ускоренной загрузки, база данных на Firebase Database. Пишу на css-flex, RXJS, для много-пользовательского общения в виде прямой конференции, но будет в демо для пары пиров. Push-Notification для сигнализации на мобильных устройствах, остальная сторона сигнализации через механизмы событий базы Database.', header : 'Приложение для обмена видео сообщениями.', img : 'assets/imgs/worksList/call-all.jpg', bgcolor : '#fffdf3', href : 'https://web-rtc-peer.herokuapp.com/', git : 'https://github.com/mechtool/web-rtc-peer'},
